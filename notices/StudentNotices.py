from html_email.Email import Email
from utils.Dates import custom_strftime, today
from notices.DatabaseBase import ExtendMoodleDatabaseToAutoEmailer
from notices.Model import DatabaseObject
import datetime
